        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><s:property value="#session.userName"></s:property></span>
            </a>
    ...
    <section class="sidebar">
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><s:property value="#session.userName"></s:property>
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li  class="treeview active">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="spotOrderHandle"><i class="fa fa-circle-o text-yellow"></i>点钟手发</a></li>
                ...
                <input type="hidden" name="clockCategoryId" value="<s:property value='sendOrderDto.clockCategory.id'/>"/>
                  ...
                  <div class="form-group">
                    ...
                    <s:iterator value="sendOrderDto.roomCategorySet" id="roomCategory">
                    	<option><s:property value="#roomCategory.roomCategory"/></option>
                    </s:iterator>
                  ...
                  <div class="form-group">
                    <input type="button" onclick="submitOrder('createOrder')" class="btn btn-info pull-left" value="发布"/>
                  </div>
                </form>
              </div>
            </div>
