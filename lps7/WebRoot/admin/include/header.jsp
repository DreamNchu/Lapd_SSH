...
%> --%>
<a href="" class="logo" style="background-color: #333333"> <span
	class="logo-mini"><b>☆</b></span> <span class="logo-lg"><b>
			小店助手</b></span>
</a>
<nav class="navbar navbar-static-top" role="navigation"
	...
	<div class="navbar-custom-menu">
		...
		<label id="currentTime">2017-11-27-18-19</label>
		</a>
		</li>
			...
			<li class="dropdown user user-menu"><a href="#"
				...
				<ul class="dropdown-menu">
					<li class="user-header"><img src="dist/img/user2-160x160.jpg"
						class="img-circle" alt="User Image"> </br> <lable
							style="font-family: 楷体"></lable> </br>注册时间2017-12-11</li>
				</ul></li>
