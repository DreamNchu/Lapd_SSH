                ...
                <i class="fa fa-angle-left pull-right"></i>
                  ...
                  <i class="fa fa-angle-left pull-right"></i>
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="rankOrderAuto"><i class="fa fa-circle-o text-green"></i>排钟自发</a></li>                       
                            </ul>
                        </li>
                    ...
                    <div class="box">
                        ...
                        <div class="box box-warning">
                            <div class="box-header with-border">
                                <h3 class="box-title">排钟订单发布--自发</h3>
                            </div>
                            <div class="box-body">
                                <form role="form" id="createOrder">
                                    ...
                                    <div class="form-group">
                                        <label>选择项目</label>
                                        <select class="form-control" name="roomCategoryId">
                                    ...
                                    <div class="form-group">
                                        <input type="button" class="btn btn-info pull-right" onclick="submitOrder('createOrderAuto')" value="发布"/>
                                    </div>
                                </form>
                            </div>
                        </div>
