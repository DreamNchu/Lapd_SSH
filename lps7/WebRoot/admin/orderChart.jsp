...
<head>
    ...
    <script>
        ...
        function receviveUser(userData) {
          /*   var userData={
                "user":[{"wordId":"workId1","userName":"userName1"},{"wordId":"workId2","userName":"userName2"},{"wordId":"workId3","userName":"userName3"}]
            }; */
            var userSelect=document.getElementById("user");
            var i;
            for(i in userData.user){
                var op=document.createElement("option");
                op.value=userData.user[i].id;
                op.innerHTML="工号: "+userData.user[i].workId+"---姓名: "+userData.user[i].realName;
