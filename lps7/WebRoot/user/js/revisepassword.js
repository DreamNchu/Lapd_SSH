window.onload=function () {
    ...
    selectmethod.onchange=function () {
        select.style.display=this.value==2?"block":"none";
        answer.style.display=this.value==2?"block":"none";
        oldpassword.style.display=this.value==1?"block":"none";
    }
}
function blue() {
    ...
    if(name.value.length<1){
        title.innerHTML="旧密码未填写";
        title.style.color="red";
        oldpassword.style.color="black";
        signbutton.disabled=true;
        return false;
    }else{
        oldpassword.style.color="green";
    }
